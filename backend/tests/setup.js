...
process.env.ENCRYPTION_KEY_CURRENT_VERSION = process.env.ENCRYPTION_KEY_CURRENT_VERSION_TEST ?? '1';
process.env.ENCRYPTION_KEY_V1 =
  process.env.ENCRYPTION_KEY_V1_TEST ?? 'MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY=';
process.env.CONTACT_LOOKUP_HMAC_KEY =
  process.env.CONTACT_LOOKUP_HMAC_KEY_TEST ??
  'Y29udGFjdC1sb29rdXAtaG1hYy1rZXktZm9yLXdhbS1jcm0tYWktdGVzdA==';
